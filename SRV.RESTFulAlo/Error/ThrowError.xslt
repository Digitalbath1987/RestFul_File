  ...
  <xsl:template match="/Detalles">
    ...
    <div class="table-responsive">
      <table>
        ...
        <tr>
          <td>
            <IMG id = "IMG_MostrarError" SRC="#" ALT="Mostrar Detalles" onClick="MostrarThrow();"></IMG>
            <IMG id = "IMG_OcultarError" SRC="#" ALT="Ocultar Detalles" onClick="OcultarThrow();"  style ="display: none;" ></IMG>
          </td>
        </tr>
        <tr>
          <td>
